...
(begin (* 213414321 2135246536) (+ 100 200))
;expect 300

(begin (define (error error) error) (define (dangarcia dangarcia) dangarcia))
;expect dangarcia

(lambda (scheme is cool) (* scheme is cool))
;expect (lambda (scheme is cool) (* scheme is cool))

((lambda (hip hop hippity) (- hip (+ hop hippity))) 3 5 9)
;expect -11

(and (+ 10 5) (* 7 9) (/ 1 0) (- 6 8))
;expect Error: division by zero

(and (+ 10 5) (define (f y) (+ y 3)) #f (/ 1 0) (- 6 8))
;expect #f

(f 3)
;expect 6

(or 22 #f (/ 10) random jibberish)
;expect 22

(or 0 0 0 5)
;expect 0

(cond ((> 2 3) (quote hehehe)) ((= 16 -16) (quote hahaha)) (else (quote hihihi)))
;expect hihihi

(cond ((< -1 -10) (quote november)) ((< 10 1.0) (quote january)) ((= 0 0) (quote april)) (else (quote october)))
;expect april

(define z 'thirtythree)
;expect z
...
(define cow (mu () (- pig horse)))
;expect cow

(define goat (lambda (horse) (define pig 10) (define horse 60) (cow)))
;expect goat

(goat 235210)
;expect -50

(define-macro (multiplier x y z) (list '* x y z))
;expect multiplier

(multiplier 2 4 6)
;expect 48

(define-macro (combiner list1 list2) (list 'list list1 list2))
;expect combiner

(combiner (list 1 'cool 3) (list 4 'amazing 6))
;expect ((1 cool 3) (4 amazing 6))
